      ...
      <Tilt
        ...
        <motion.div
          ...
          <Image
            ...
            height={400}
            alt="project_image"
            className=" object-fill rounded-2xl relative"
          />

          <div className="absolute top-5 right-14 md:right-5 m-3 text-white">
            <div
...
const Works = () => {
  return (
    <div id="works" className="mt-36 md:mt-40 md:my-2 text-white">
      ...
      <div className="mt-20 grid md:grid-cols-3 grid-cols-1 gap-7 place-content-center">
